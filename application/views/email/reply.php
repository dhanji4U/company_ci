...
<head>
    ...
    <title><?php PROJECT_NAME ?> - Reply From Serve Me</title>
...
<body style="margin:0;padding:0;background-color:#FFF">
    <center>
        <table align="center" border="0" cellpadding="0" cellspacing="0" id="bodyTable" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding:0;background-color:#FFF;height:100%;margin:0;width:100%">
            <tbody>
                <tr>
                    <td align="center" class="card" id="bodyCell" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding-top:50px;padding-left:20px;padding-bottom:20px;padding-right:20px;border-top:0;height:100%;margin:0;width:100%">
                        <!--[if !mso]><!-->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        background: linear-gradient(to right, #fff 0%, #fff 100%) !important;">
                                                                                            <!-- Your Logo -->
                                                                                            <img align="center" class="kmImage" src="<?php echo base_url().LOGO_NAME; ?>" alt="<?php echo PROJECT_NAME; ?>" type="image/x-icon" width="100" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;padding-bottom:0;display:inline;vertical-align:bottom;max-width:199px;border-radius: 5px;" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                                            ...
                                                                                            <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;"><strong><span style="font-size: 16px;">Dear</span></strong> </span><strong><span style="font-size:18px;"> <strong><?php echo $this->input->post('name')
                                                                                                                                                                                                                                                                                                    ?>,</strong></span></span></p>
                                                                                            <p style="margin:0;padding-bottom:1em">Thanks For Contact Us.</p>
                                                                                            <p style="margin:0;padding-bottom:1em">This mail is for you contact with us organization.</p>
                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Subject : </small> <b><?php echo $this->input->post('subject') ?></b> </p>
                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Our Reply: </small><b><?php echo $this->input->post('reply_text'); ?></b> </p>
                                                                                            ...
                                                                                            <p style="margin:0;padding-bottom:1em;text-align:right;"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Kind Regards,</span></span></p>
                                                                                            <p style="margin:0;padding-bottom:0;text-align:right;"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;"><?php echo PROJECT_NAME ?></span></span></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
