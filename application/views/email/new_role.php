...
<head>
    ...
    <title><?php echo PROJECT_NAME; ?> - New Role</title>
            ...
            <tbody>
                <tr>
                    <td align="center" id="bodyCell" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;padding-top:50px;padding-left:20px;padding-bottom:20px;padding-right:20px;border-top:0;height:100%;margin:0;width:100%">
                        <!--[if !mso]><!-->
                        <div class="templateContainer" style="border:1px none #aaa;border-radius:45px 0px 45px 0px;background: linear-gradient(to right, #ffffff 0%, #ffffff 100%);display: table; width:600px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        background: linear-gradient(to right, #ffffff 0%, #ffffff 100%) !important;">
                                                                                            <img align="center" alt="Logo" class="kmImage" src="<?php echo base_url() . LOGO_NAME; ?>" width="100" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;padding-bottom:0;display:inline;vertical-align:bottom;max-width:199px;" />
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                                            ...
                                                                                            <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Dear <strong><?php echo $this->input->post('name') ?></strong>,</span></span></p>

                                                                                            <p style="margin:0;padding-bottom:1em">I hope this message finds you well. We are delighted to inform you that you have been appointed as a <b><?php echo $role_type ?></b>. Your role is vital in helping us serve our community effectively.</p>

                                                                                            <p style="margin:0;padding-bottom:1em">As a <b><?php echo $role_type ?></b>, you will have various responsibilities and access to specific systems and tools to fulfill your duties. To get started, we have provided you with your login credentials below:</p>

                                                                                            <?php if ($role_type == 'local authority') { ?>

                                                                                                <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Local Authority Panel Link : </small> <b><?php echo base_url(); ?>local_authority/auth</b> </p>

                                                                                            <?php } ?>

                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Email : </small> <b><?php echo $this->input->post('email') ?></b> </p>
                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Temporary Password: </small><b><?php echo $this->input->post('password'); ?></b> </p>

                                                                                            <span style="margin:0;padding-bottom:1em;font-size:15px;font-family:arial,helvetica,sans-serif;"><strong>Important: Please Change Your Password</strong></span>

                                                                                            <p style="margin:0;padding-bottom:1em">For security reasons, we recommend that you change your password immediately upon logging in for the first time. You can do this by following the password reset process within the system.</p>

                                                                                            <p style="margin:0;padding-bottom:1em">Once again, welcome to the team! We look forward to working with you and making a positive impact on our community.</p>

                                                                                            <p style="margin:0;padding-bottom:0.5em"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Best regards,</span></span></p>

                                                                                            <p style="margin:0;padding-bottom:0"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;"><?php echo PROJECT_NAME; ?> Team</span></span></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
