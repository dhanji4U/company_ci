...
<head>
    ...
    <title><?php echo PROJECT_NAME; ?> - Sub Admin</title>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                                            ...
                                                                                            <p style="margin:0;padding-bottom:1em">Hear is Your Login Credential.Please Do not share to anyone.</p>
                                                                                           
                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Admin Panel link : </small> <b><?php echo base_url(); ?>admin/login</b> </p>
                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Email : </small> <b><?php echo $this->input->post('email') ?></b> </p>
                                                                                            <p style="margin:0;padding-bottom:1em;font-size:15px;"><small>Password: </small><b><?php echo $this->input->post('password'); ?></b> </p>
